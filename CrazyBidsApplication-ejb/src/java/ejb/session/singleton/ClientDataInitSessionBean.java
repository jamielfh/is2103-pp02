...
public class ClientDataInitSessionBean {
    ...
    public void postConstruct()
    {
        ...
        if(em.find(Auction.class, 1l) == null) {
            try {
                auctionSessionBeanLocal.createAuction(new Auction("book1", "life of book 1", currentDate, newDate, new BigDecimal(5), new BigDecimal(50), false, false, false));
                auctionSessionBeanLocal.createAuction(new Auction("book2", "life of book 2", currentDate, newDate, new BigDecimal(10), new BigDecimal(60), false, false, false));
                auctionSessionBeanLocal.createAuction(new Auction("book3", "life of book 3", currentDate, newDate, new BigDecimal(20), new BigDecimal(70), false, false, false));
                auctionSessionBeanLocal.createAuction(new Auction("book4", "life of book 4", currentDate, newDate, new BigDecimal(30), new BigDecimal(80), false, false, false));
                auctionSessionBeanLocal.createAuction(new Auction("book5", "life of book 5", currentDate, newDate, new BigDecimal(40), new BigDecimal(90), false, false, false));
            } catch (GeneralException ex) {
                ex.printStackTrace();
            }
        }
